...
const professionalAPIMOCK = [
	{
		name: "Ramilthon",
		expediente: [
			{
				weekDay: "seg",
				inicioExpediente: "09:30:00",
				fimExpediente: "15:00:00",
			},
			{
				weekDay: "ter",
				inicioExpediente: "09:30:00",
...
// let sla2 = {
// 	daySelected: 28,
// 	horariosDisponiveis: ["07:00", "07:30", "08:00", "08:30", "10:00", "10:30"],
// };

// // exemplo de horarios já marcados
// let sla3 = [
//   {
//     startTime: "09:00",
//     endTime: "09:50",
...
const fetchAppointment = (date) => {
	const dataAPIMOCK = [
		{
			date: new Date("2023-10-29T23:10:00"),
			appointmentStatus: "",
		},
	];
	...
	console.log(formatDate(dataAPIMOCK[0].date));
	console.log(formatDate(dataAPIMOCK[0].date) == formatDate(date));
};
