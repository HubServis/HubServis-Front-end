            ...
            <AppBar>
             ...
             <section className="bg-gradient-to-r from-[#00E12580] via-[#51F16B80] to-[#00993380] bg-opacity-50 h-96 w-full relative">
                        ...
                        <div className="mix-blend-overlay">
                            <img src={Bgbanner} alt="banner" id="" className="w-full h-full object-cover absolute"/>
                        </div>
                          ...
                          <div className="object-right text-right p-20 pr-60 mb-6">
                           ...
                           <button type="button" className="inline-block shadow py-3 w-48 h-12 tracki text-center rounded bg-[#009933] text-white">Adquirir Ingresso</button>
                          </div>
                    ...
                    <section className="p-10 pt-20">
                        <span className="flex inline justify-between align-center">
                         <h1 className="font-bold pt-6">Ofertas em Destaques</h1>
                         <BtnOutlinedGreen
                        ...
                        <div className="flex justify-between border-2 border-green-300">
                         <CardService />
                         <CardService />
                         <CardService />
                         <CardService />
                    ...
                    <section className="p-10 flex justify-between align-center">
                        <aside>
                         <img src={PercImg} alt="" id="" className="border border-2 border-blue-300 float-left w-1/2" />

                            <div className="pt-10 float-right pl-10">
                             
                                <h1 className="text-lg font-bold">Ofertas Especiais</h1>
                                ...
                                <div className="pt-10">
                                 <button type="button" className="inline-block px-5 py-3 font-semibold w-36 h-14 tracki text-center rounded bg-[#009933] text-white">Conferir</button>
                                </div>
