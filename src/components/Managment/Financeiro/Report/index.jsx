      ...
      <div className="mb-4 py-[15px] border-2 rounded-[8px] border-[var(--light-green)]">
        ...
        <div className="mt-[65px] mx-[17px]">
          <div className="flex justify-between items-end">
            <div className="flex gap-[10px]">
              <div>
                <p className="text-sm text-[var(--gray-opacity-25)]">Data Inicío</p>
                <DateSelectDefault />
              </div>
              <div>
                <p className="text-sm text-[var(--gray-opacity-25)]">Data Fim</p>
                <DateSelectDefault />
              </div>
            </div>
            <BtnFillGreen> 
        ...
        <div className="mt-[50px] mx-[17px] flex justify-between gap-[50px]">
            <div className="px-[15px] py-[10px] border-2 border-[var(--light-green)] max-w-[300px] w-full rounded-[8px]">
                ...
                <p className="text-[var(--strong-green)] font-semibold text-2xl">R$ 0,00</p>
            </div>
            <div className="px-[15px] py-[10px] border-2 border-[var(--light-green)] max-w-[300px] w-full rounded-[8px]">
            ...
            <div className="px-[15px] py-[10px] border-2 border-[var(--light-green)] max-w-[300px] w-full rounded-[8px]">
                ...
                <p className="text-[var(--strong-green)] font-semibold text-2xl">0</p>
            </div>
            <div className="px-[15px] py-[10px] border-2 border-[var(--light-green)] max-w-[300px] w-full rounded-[8px]">
