        ...
        <div className="flex">
            <nav className="max-w-[90px] group/menu hover:max-w-[320px] bg-[var(--black)] pt-6 flex flex-col justify-start duration-200 h-auto">
                <div className="flex flex-col items-start mt-3 gap-[5px]">
                    ...
                    >
                        ...
                        >
                            <p
                                className="max-w-[fit-content]"
                                onClick={() => setContext(6)}
                            >
                                Listagem
                            </p>
                            <p
                                className="max-w-[fit-content]"
                                onClick={() => setContext(7)}
                            >
                                Categorias
                            </p>
                        </div>
                    ...
                    >
                        ...
                        >
                            <p
                                className="max-w-[fit-content]"
                                onClick={() => setContext(8)}
                            >
                                Listagem
                            </p>
                            <p
                                className="max-w-[fit-content]"
                                onClick={() => setContext(9)}
                            >
                                Categorias
                            </p>
                        </div>
                    ...
                    >
                        ...
                        >
                            <p
                                className="max-w-[fit-content]"
                                onClick={() => setContext(10)}
                            >
                                Profissionais
                            </p>
                            <p
                                className="max-w-[fit-content]"
                                onClick={() => setContext(11)}
                            >
                                Expedientes
                            </p>
                        </div>
                ...
                <div className="mb-10 mt-3 cursor-pointer">
                    ...
                    <div
                        className="flex bg-[#2C2C2C] mx-3 px-4 py-2 rounded-[10px] gap-1"
